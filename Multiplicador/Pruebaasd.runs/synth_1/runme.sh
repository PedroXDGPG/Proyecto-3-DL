...
HD_PWD='C:/Users/LAPTOP HP/Downloads/Pruebaasd/Pruebaasd.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mult_with_no_sm.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mult_with_no_sm.tcl
