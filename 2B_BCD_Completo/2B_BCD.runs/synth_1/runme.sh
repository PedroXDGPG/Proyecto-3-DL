...
HD_PWD='C:/Users/LAPTOP HP/Documents/Tec/DLogico/Proyecto3/2B_BCD - copia - copia/2B_BCD.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log B_BCD.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source B_BCD.tcl
